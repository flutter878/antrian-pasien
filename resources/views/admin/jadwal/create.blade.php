...
<div class="row mb-4 align-items-center">
    <div class="col">
        <h4 class="mb-0 fw-bold">
            <i class="bi bi-calendar-plus me-2 text-success"></i>Tambah Jadwal Praktek
        </h4>
        <small class="text-muted">Buat jadwal baru untuk dokter.</small>
    </div>
    <div class="col-auto">
        ...
        <form action="{{ route('admin.jadwal.store') }}" method="POST">
            ...
            <div class="row g-3 mt-3">
                <div class="col-md-4">
                    ...
                    <input type="number" name="kuota" value="{{ old('kuota') }}" min="1" class="form-control @error('kuota') is-invalid @enderror">
                    @error('kuota')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4 d-flex align-items-end">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="aktif" id="aktif" {{ old('aktif') ? 'checked' : '' }}>
